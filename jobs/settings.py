...
# Remove language fallback setting
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='Job Portal <noreply@jobportal.com>')
...
AUDIT_ENABLED = True
AUDIT_LOG_NON_TEXT_FIELDS = True
AUDIT_ADMIN_LOG_BACKEND = 'audit.backends.ModelBackend'
